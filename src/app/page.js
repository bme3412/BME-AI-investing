    ...
    <div className="min-h-screen bg-black">
      ...
      <header className="flex justify-between items-center p-6">
        <div className="flex items-center space-x-6">
          <h2
            className="font-mono text-2xl tracking-tight font-bold
          ...
          <Link href="/about" className="relative group">
            <button
              className="px-6 py-2.5 text-white border border-white/50 rounded-lg
      ...
      <main className="container mx-auto px-4 pt-12 md:pt-24 text-center min-h-[70vh] flex flex-col items-center justify-center">
        <h1 className="text-4xl md:text-7xl font-bold max-w-5xl mx-auto leading-tight text-white font-sans">
          AI will{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-500 hover:scale-105 transition-transform duration-300 inline-block">
            transform
          </span>{" "}
        ...
        <div className="mt-8 text-lg md:text-xl text-gray-400 max-w-3xl mx-auto font-sans space-y-4">
          <p>
            AI is already changing the world. Integrating generative AI into
            investment management is a generational opportunity that will
